                  ...
                  <div class="row justify-content-center align-items-center">
                    ...
                    <div class="card ml-2 mr-2 mb-5" style="width: 295px;">
                      ...
                      <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><span style="color: blueviolet; font-weight:bold">Fee:</span> 130K per person</li>
                   ...
                   <!--Standard card start -->
                    <div class="card ml-2 mr-2 mb-5" style="width: 295px;">
                      ...
                      <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><span style="color: blueviolet; font-weight:bold">Fee:</span> 140K per person</li>
