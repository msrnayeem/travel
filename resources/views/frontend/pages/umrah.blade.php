        ...
        <div class="swiper-form-wrap">
            ...
            <div class="swiper-container swiper-slider swiper-slider_height-1 swiper-align-left swiper-align-left-custom context-dark bg-gray-darker"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide" data-slide-bg="{{ asset('img/medina.jpg') }}">
                        <div class="swiper-slide-caption">
                            <div class="container container-bigger swiper-main-section">
                                <div class="row row-fix justify-content-sm-center justify-content-md-start">
                                    <div class="col-md-6 col-lg-5 col-xl-4 col-xxl-5 position-relative">
            ...
            <div class="row row-fix justify-content-xl-end row-30 text-center text-xl-left">
                <div class="col-xl-8">
                    <div class="parallax-text-wrap">
                        <h3>Our Umrah Packages</h3><span class="parallax-text">Best Package</span>
                    </div>
                    <hr class="divider divider-decorate">
                </div>
                <div class="col-xl-3 text-xl-right">
                    <a class="btn sbmt" href="#">view all packages</a>
                </div>
            </div>
                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="card ml-2 mr-2 mb-5" style="width: 295px;">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item font-weight-bold text-start">
                                        <span style="color: blueviolet; font-weight:bold">Fee:
                                        </span> 130K per person
                                    </li>
                                    <li class="list-group-item font-weight-bold text-start">
                                        <span style="color: blueviolet; font-weight:bold">Depart:
                                        </span> {{ \Carbon\Carbon::today()->addDays(15)->format('d-m-Y') }}
                                    </li>
                                    <li class="list-group-item font-weight-bold text-start">
                                        <span style="color: blueviolet; font-weight:bold">Return:
                                        </span> {{ \Carbon\Carbon::today()->addDays(30)->format('d-m-Y') }}
                                    </li>
            ...
            <div class="row row-50">
                <div class="col-sm-12">
                    ...
                    <div class="owl-carousel owl-carousel-team owl-carousel-inset" data-items="1" data-md-items="2"
                        ...
                        <article class="post-blog"><a class="post-blog-image" href="#"><img
                                    src="images/landing-private-airlines-8-570x415.jpg" alt="" width="570"
                                    height="415" /></a>
                            <div class="post-blog-caption">
                                <div class="post-blog-caption-header">
                                    <ul class="post-blog-tags">
                        ...
                        <article class="post-blog"><a class="post-blog-image" href="#"><img
                                    src="images/landing-private-airlines-9-570x415.jpg" alt="" width="570"
                                    height="415" /></a>
                            <div class="post-blog-caption">
                                <div class="post-blog-caption-header">
                                    <ul class="post-blog-tags">
                ...
                <div class="col-12"><a class="btn sbmt" href="#">view all blog posts</a></div>
            </div>
        </div>
    </section>
