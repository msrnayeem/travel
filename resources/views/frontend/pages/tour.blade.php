        ...
        <div class="swiper-form-wrap">
          ...
          >
            <div class="swiper-wrapper">
              ...
              <div
                class="swiper-slide"
                data-slide-bg="{{ asset('images/tour_slider/2.jpg') }}"
              >
                <div class="swiper-slide-caption">
                  <div class="container container-bigger swiper-main-section">
                    <div
        ...
        <div class="container container-wide">
            ...
            <div class="col-md-6 col-xl-4">
                ...
                <div class="event-default">
                    <figure class="event-default-image"><img src="{{ asset('images/tours/paris.jpg') }}" alt="paris" width="570" height="370"/>
                    </figure>
            ...
            <div class="col-md-6 col-xl-4">
                <article class="event-default-wrap">
                <div class="event-default">
                    <figure class="event-default-image"><img src="{{ asset('images/tours/boston.jpg') }}" alt="boston" width="570" height="370"/>
                    </figure>
                    <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="#">learn more</a></div>
                </div>
                <div class="event-default-inner">
            ...
            <div class="col-md-6 col-xl-4">
                <article class="event-default-wrap">
                <div class="event-default">
                    <figure class="event-default-image"><img src="{{ asset('images/tours/italy.jpg') }}" alt="italy" width="570" height="370"/>
                    </figure>
                    <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="#">learn more</a></div>
                </div>
                <div class="event-default-inner">
            ...
            <div class="col-md-6 col-xl-4">
                <article class="event-default-wrap">
                <div class="event-default">
                    <figure class="event-default-image"><img src="{{ asset('images/tours/egypt.jpg') }}" alt="egypt" width="570" height="370"/>
                    </figure>
                    <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="#">learn more</a></div>
                </div>
                <div class="event-default-inner">
            ...
            <div class="col-md-6 col-xl-4">
                <article class="event-default-wrap">
                <div class="event-default">
                    <figure class="event-default-image"><img src="{{ asset('images/tours/london.jpg') }}" alt="london" width="570" height="370"/>
                    </figure>
                    <div class="event-default-caption"><a class="button button-xs button-secondary button-nina" href="#">learn more</a></div>
                </div>
                <div class="event-default-inner">
              ...
              >
                <article class="post-blog">
                  <a class="post-blog-image" href="#"
                    ><img
                    src="{{ asset('images/news/Top10Hotels.jpg') }}"
                      alt=""
                      width="570"
                      height="415"
                  /></a>
                    ...
                    <div class="post-blog-caption-body">
                      <h5>
                        <a class="post-blog-title" href="#"
                          >Top 10 Hotels to Stay At: Exclusive Rating by Sealine
                          Travel Experts</a
                        >
                      </h5>
                    </div>
                ...
                <article class="post-blog">
                  <a class="post-blog-image" href="#"
                    ><img
                    src="{{ asset('images/news/HowtoPlan.jpg') }}"
                      alt=""
                      width="570"
                      height="415"
                  /></a>
                ...
                <article class="post-blog">
                  <a class="post-blog-image" href="#"
                    ><img
                    src="{{ asset('images/news/personalGuide.jpg') }}"
                      alt=""
                      width="570"
                      height="415"
                  /></a>
